...
export default function TopicsToListen({ style }) {
  ...
  return (
    <div
      className={`${style} rounded-lg border border-dashed border-black/50 bg-customNavBg px-3 py-1`}
    >
      <div className="flex items-center">
        ...
        <div ref={toggleAllRef}>
          <Button
            text={"Toggle All"}
            style={"px-2 py-1 mx-1 ms-2 rounded-lg"}
        ...
        <div ref={selectedTopicsRef}>
          <Button
            ...
            style={"px-2 py-1 ms-1 rounded-lg"}
