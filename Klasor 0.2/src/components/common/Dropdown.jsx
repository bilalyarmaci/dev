  ...
  return (
    <div>
      <button
        ...
        className="inline-flex items-center rounded-lg border border-black bg-customNavBg px-2 py-1 text-center hover:bg-customNavBgHover hover:text-white transition-all ease-in-out"
        type="button"
      >
        {text}
      ...
      >
        <ul
          className="py-2 text-gray-700 bg-customNavBg"
              ...
              return item.value === "dd" ? (
                <li key={index} className="relative">
                  <button
                    ...
                    type="button"
                    className="flex w-full items-center justify-between rounded-lg px-4 py-2 hover:bg-customNavBgHover hover:text-white"
                  >
                    <input
                      id={`heading-${index}`}
                      type="checkbox"
                  ...
                  >
                    <ul className="py-2" aria-labelledby={`${index}dd`}>
                      {subitems.map((subitem, subitemIndex) => (
                        <li
                          key={subitemIndex}
                          className="flex items-center rounded-xl px-4 py-2 hover:bg-customNavBgHover hover:text-white" 
                        >
                          <input
